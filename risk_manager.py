...
def can_open_position(open_count, balance):
    if open_count >= MAX_POSITIONS: return False, "max posiciones"
...
def get_stats(balance):
    ...
    return {"balance": round(balance,2), "peak_balance": round(peak,2),
            ...
            "total_wins": _state["total_wins"], "total_losses": _state["total_losses"],
